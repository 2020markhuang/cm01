...
#define HAL_DISPLAY_DSI_MODULE_ENABLED
...
/*This definition determines whether the clock is enabled and we can choose which clock to use, such as MTK_SYSTEM_CLOCK_208M or MTK_SYSTEM_CLOCK_104M. This module can not be disabled.*/
...
/*The HAL_I2S_MODULE_ENABLED and HAL_AUDIO_MODULE_ENABLED determine whether we can use the sub_feature of A-mic and D-mic, and the type of A-mic could also be selected if the two modules are enabled.*/
