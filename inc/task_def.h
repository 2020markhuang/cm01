...
/* LWIP Host task definition */
#define LWIP_HOST_TASK_NAME              "lwip_host"
#define LWIP_HOST_TASK_STACKSIZE         (1024*4) /*unit byte!*/
#define LWIP_HOST_TASK_PRIO              TASK_PRIORITY_BELOW_NORMAL //don't change the priority, may lead initial fail
