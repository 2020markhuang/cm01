...
static const tasks_list_t tasks_list[] = {
	{ main_task,         "main_task",      10240,     NULL,   TASK_PRIORITY_HIGH },		
	#ifdef SUPPORT_MY_4G
	{ module4g_task,         "4g_task",      4096,     NULL,   TASK_PRIORITY_NORMAL },
	#endif	  
	{ watch_task,         "watch_task",      1024,     NULL,   TASK_PRIORITY_NORMAL },
	#ifdef MTK_ATCI_ENABLE
	#if defined(MTK_ATCI_VIA_PORT_SERVICE) && defined(MTK_PORT_SERVICE_ENABLE)
